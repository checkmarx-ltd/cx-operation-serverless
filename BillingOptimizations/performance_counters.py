class PerformanceCounters:
    ...
    def __init__(self, start_time, cpu_utilization = None, network_in = None, network_out = None, network_packets_in = None, network_packets_out = None, disk_write_ops = None, disk_read_ops = None, disk_write_bytes = None, disk_read_bytes = None, is_idle = None):
